...
<script>
  ...
  export default {
    ...
    data() {
      return {
        tableData: [{name: '曾肖宇', phone: '13000000000', schoolId: '3118000000', major: '网工', direction: '后台'},
        {name: '陈诒祺', phone: '13000000000', schoolId: '3118000000', major: '网工', direction: '后台'},
        {name: '邓靖汐', phone: '13000000000', schoolId: '3118000000', major: '网工', direction: 'UI'}],
        total: 0,
        loading: true,
        modalVisible: false,
        currentStudent: {},
