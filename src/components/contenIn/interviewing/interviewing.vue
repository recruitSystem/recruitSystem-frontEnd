...
<script>
  ...
  export default {
    ...
    data() {
      return {
        tableData: [{student: {name: '曾肖宇', phone: '13000000000', schoolId: '3118000000', direction: '后台'}, orderCount: 1, interviewed: '否'}, {student: {name: '陈诒祺', phone: '13000000000', schoolId: '3118000000', direction: '后台'}, orderCount: 2, interviewed: '否'}, {student: {name: '邓靖汐', phone: '13000000000', schoolId: '3118000000', direction: '后台'}, orderCount: 3, interviewed: '否'},], // 表格数据
        loading: false,
        timer: {
          getList: '',
          getComment: '',
